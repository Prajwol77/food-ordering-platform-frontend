        ...
        <table className="min-w-full bg-white">
          ...
          <tbody>
            {restaurants?.map((restaurant, index) => (
              <tr key={index}>
                <td className="py-2 px-4 border-b border-gray-200 text-center cursor-pointer underline underline-offset-2" onClick={() => navigate(`/admin/dashboard/restaurant/${restaurant._id.toString()}`)}>
